        ...
        <div class="col-md-10 jumbotron">
            <div class="row justify-content-center">
                <div class="col-md-4">
                    ...
                    <p><strong>{{$categories->post()->count()}} Videos/Articles</strong></p>
                </div>
                <div class="col-md-4">
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <p><h2>{{$categories->name}}</h2></p>
                                    <p>The category to be deleted has about <strong>{{$categories->post()->count()}} Videos/Articles</strong></p>
                                </div>
                                <div class="modal-footer">
                                    {!! Form::open(['action' => ['CategoryController@destroy', $categories->id], 'method' => 'DELETE']) !!}
